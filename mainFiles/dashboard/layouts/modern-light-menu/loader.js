window.addEventListener("load", function(){
        ...
        settings: {
            layout: {
                ...
                logo: {
                    ...
                    lightLogo: 'assets/imgs/shar_logo.svg")}}'
                }
            }
        },
        reset: false
    ...
    if (corkThemeObject.settings.layout.darkMode) {
        ...
        if (getParseObject.settings.layout.darkMode) {
            ...
            if (ifStarterKit) {
                if (document.querySelector('.navbar-logo2')) {
                    document.querySelector('.navbar-logo2').setAttribute('src', 'assets/imgs/shar_logo.svg')
                }
            } else {
                if (document.querySelector('.navbar-logo2')) {
                    document.querySelector('.navbar-logo2').setAttribute('src', getParseObject.settings.layout.logo.darkLogo)
                }
            }
        }
    } else {
